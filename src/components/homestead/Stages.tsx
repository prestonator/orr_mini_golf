...
export function Stages({ nodes, materials, currentStage }: { nodes: any, materials: any, currentStage: number }) {
  return (
    <group position={[19.18, 0, -18.073]} rotation={[-Math.PI / 2, 0, 0]}>
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        ...
        <AnimatedGroup stage={1} currentStage={currentStage} dropHeight={0}>
          <group position={[-7500, 0, 3500]} scale={[0.5, 1, 4.5]}><mesh geometry={nodes.Env_Grass_1_SimpleFarm_0001.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-2600, -2, 2800]} scale={[54.86, 1, 63.69]}><mesh geometry={nodes.Plane_GrassFarm_0.geometry} material={materials['GrassFarm.001']} position={[7.26, 0, -8.79]} /></group>
          ...
          {/* Dirt & Roads */}
          <group position={[-2000, 0, 4999.999]}><mesh geometry={nodes.Env_Dirt_Road_Corner_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} /></group>
          <group position={[-2000, 0, 4000]} scale={[1, 1, 0.5]}><mesh geometry={nodes.Env_Dirt_Road_Straight_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} /></group>
          <group position={[-5000, 0, 4000]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.road_Dirt_Driveway_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
          <group position={[-5000, 0, 6000]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.road_Dirt_Driveway_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
          <group position={[-5000, 0, 4999.999]} rotation={[0, -1.571, 0]} scale={[2, 1, 1]}><mesh geometry={nodes.road_Dirt_Straight_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
          <group position={[-7000, 0, 3000]} rotation={[0, 1.571, 0]} scale={[7, 1, 1]}><mesh geometry={nodes.road_Dirt_Straight_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
          <group position={[-5000, 0, 7000]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.road_Dirt_Transition_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0.001]} /></group>
          ...
          <mesh geometry={nodes.road_Dirt_Intersection_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-7000, 0, 6000]} rotation={[0, 1.571, 0]} />
        ...
        <AnimatedGroup stage={4} currentStage={currentStage}>
          <group position={[-4872.725, 0, 5162.175]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.Prop_Trough_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0.001, 0, -0.001]} /></group>
        ...
        <AnimatedGroup stage={5} currentStage={currentStage}>
          <group position={[-1326.243, 0, 5411.097]}><mesh geometry={nodes.Prop_Well_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
        </AnimatedGroup>
        ...
        <AnimatedGroup stage={8} currentStage={currentStage} animType="grow">
          <group position={[-5000, 0, -2000]}><mesh geometry={nodes.Env_Crop_Cabbage_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, -1000]}><mesh geometry={nodes.Env_Crop_Corn_Young_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, 0]}><mesh geometry={nodes.Env_Crop_Maze_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
        ...
        <AnimatedGroup stage={15} currentStage={currentStage}>
          <group position={[-4293.447, 0, 6739.821]}><mesh geometry={nodes.Prop_Haybale_Stack_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          ...
          <mesh geometry={nodes.Prop_Haybale_02_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-192.781, 0, -2803.858]} />
          ...
          <mesh geometry={nodes.Prop_Haybale_Stack_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[1645.308, 0, -1217.531]} />
        ...
        <AnimatedGroup stage={17} currentStage={currentStage}>
          <group position={[-5001.748, 38.148, 4135.983]} rotation={[0, 1.571, 0]}>
            <mesh geometry={nodes.Prop_Letter_Box1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} />
            <mesh geometry={nodes.flag_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-26.701, 163.645, -26.65]} />
          </group>
        </AnimatedGroup>
        ...
        <AnimatedGroup stage={19} currentStage={currentStage}>
          <group position={[-5000, 0, 4999.999]}><mesh geometry={nodes.Prop_Fence_Ranch_Sign_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, -0.001]} /></group>
          <group position={[-2710.649, 0, 3100]}><mesh geometry={nodes.Prop_Fence_White_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          <group position={[-3710.649, 0, 3100]} rotation={[0, -1.571, 0]}>
            ...
            <mesh geometry={nodes.Gate_01_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 119.085, -223.481]} rotation={[0, 1.555, 0]} />
        ...
        <AnimatedGroup stage={21} currentStage={currentStage}>
          <group position={[-5000, 0, 4000]}><mesh geometry={nodes.Prop_Fence_Brown_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, 2000]}><mesh geometry={nodes.Prop_Fence_Brown_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, -1000]}><mesh geometry={nodes.Prop_Fence_Brown_10_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, -2000]}><mesh geometry={nodes.Prop_Fence_Brown_11_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, -3000]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.Prop_Fence_Brown_12_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-4000, 0, -3000]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.Prop_Fence_Brown_13_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-1000, 0, -3000]} rotation={[0, -1.571, 0]}><mesh geometry={nodes.Prop_Fence_Brown_15_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, 3000]}><mesh geometry={nodes.Prop_Fence_Brown_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[2000, 0, 4999.999]} rotation={[Math.PI, 0, Math.PI]}><mesh geometry={nodes.Prop_Fence_Brown_22_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
          <group position={[3000, 0, 2000]} rotation={[0, 1.571, 0]}><mesh geometry={nodes.Prop_Fence_Brown_27_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          <group position={[-5000, 0, 6000]}><mesh geometry={nodes.Prop_Fence_Brown_3_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, 1000]}><mesh geometry={nodes.Prop_Fence_Brown_8_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, 0]}><mesh geometry={nodes.Prop_Fence_Brown_9_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-7432, 0, 4954.999]} rotation={[0, 0.01, 0]}><mesh geometry={nodes.Prop_Fence_Brown__1__SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[-5000, 0, 7000]}>
            <group position={[-0.001, 119.085, -223.482]} rotation={[0, -0.979, 0]}><mesh geometry={nodes.Gate_01_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
            <group position={[-0.001, 119.085, -780.48]} rotation={[0, 0.965, 0]}><mesh geometry={nodes.Gate_02_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
            <mesh geometry={nodes.Prop_Fence_Gate_Brown_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} />
          </group>
          ...
          <mesh geometry={nodes.Prop_Fence_Brown_23_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[2000, 0, 4000]} rotation={[Math.PI, 0, Math.PI]} />
        ...
        <AnimatedGroup stage={22} currentStage={currentStage}>
          <group position={[-3817.529, 0, 3421.572]} rotation={[0, 0.433, 0]} scale={0.642}>
            <group position={[0, 76.283, -195.335]}><mesh geometry={nodes.Wheel_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          ...
          <group position={[-2701.329, 0, 5837.252]} rotation={[0, -0.592, 0]} scale={0.642}>
            <group position={[0, 76.283, -195.335]}><mesh geometry={nodes.Wheel_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} /></group>
        ...
        <AnimatedGroup stage={23} currentStage={currentStage}>
          {/* Fruit Trees Grow */}
          <group position={[1750.368, -2.34, 4038.941]} rotation={[0, 0.464, 0]}><mesh geometry={nodes.Prop_Tree_Apple_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-0.001, 0, 0]} /></group>
          <group position={[849.562, -2.34, 2840.459]} rotation={[0, 0.464, 0]}><mesh geometry={nodes.Prop_Tree_Apple_3_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          <group position={[1750.39, -2.34, 3588.074]} rotation={[0, -0.586, 0]}><mesh geometry={nodes.Prop_Tree_Orange_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0.001, 0, 0]} /></group>
          ...
          <group position={[-2961.359, -1.871, 5183.392]} rotation={[-Math.PI, 0.958, -Math.PI]}>
            <group position={[-135.622, 58.112, -243.814]}><mesh geometry={nodes.Wheel_fl_14_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
            <group position={[135.624, 58.112, -243.814]}><mesh geometry={nodes.Wheel_fr_14_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0.001, 0, 0]} /></group>
            <group position={[-135.622, 58.112, 222.57]}><mesh geometry={nodes.Wheel_rl_14_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} /></group>
            <group position={[135.623, 58.112, 222.57]}><mesh geometry={nodes.Wheel_rr_14_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} /></group>
            <mesh geometry={nodes.Vehicle_Farm_Flatbed_02_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0.001, 0, 0]} />
          </group>
          <group position={[13.062, 0, 2440.23]} rotation={[-Math.PI, 1.138, -Math.PI]}>
            ...
            <mesh geometry={nodes.Wheel_rr_8_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[135.622, 58.112, 222.57]} />
          </group>
        </AnimatedGroup>
        ...
        <AnimatedGroup stage={24} currentStage={currentStage}>
          ...
          <group position={[-3170.541, 0, 3468.029]} rotation={[0, -0.88, 0]}>
            <group position={[135.78, 54.059, -217.878]}><mesh geometry={nodes.Wheel_fr_12_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} /></group>
            ...
            <mesh geometry={nodes.Wheel_rl_12_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-135.781, 54.059, 224.72]} />
            <mesh geometry={nodes.Wheel_rr_12_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[135.78, 54.059, 224.72]} />
          </group>
          <group position={[-4484, 0, 4490]} rotation={[0, -1.571, 0]}>
            <group position={[-135.78, 54.059, 224.72]}><mesh geometry={nodes.Wheel_rl_4_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          ...
          <group position={[-3699.736, 0, 1500]} rotation={[0, -1.571, 0]}>
            ...
            <mesh geometry={nodes.Wheel_rl_10_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-209.668, 110.959, 241.943]} />
            <mesh geometry={nodes.Wheel_rr_10_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[209.668, 110.959, 241.943]} />
          </group>
          <group position={[-1471.96, 0, -476.27]} rotation={[0, 1.571, 0]}>
            ...
            <mesh geometry={nodes.Wheel_rr_3_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[186.694, 110.959, 240.215]} />
          </group>
          <group position={[-1535.507, 4.833, 2981.15]}>
            ...
            <mesh geometry={nodes.Wheel_fr_7_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[169.619, 82.018, 530.991]} />
            <mesh geometry={nodes.Wheel_rl_7_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-169.62, 82.018, 713.06]} />
            <mesh geometry={nodes.Wheel_rr_7_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[169.619, 82.018, 713.06]} />
          </group>
          <group position={[-780.046, 0, -2581.117]} rotation={[Math.PI, 0, Math.PI]}>
            <group position={[-166.58, 125.564, 214.741]}><mesh geometry={nodes.Wheel_rl_13_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
            ...
            <mesh geometry={nodes.Wheel_rr_13_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[162.485, 125.564, 214.741]} />
          </group>
          <group position={[-2167.666, 0, 5398.339]}>
            ...
            <mesh geometry={nodes.Wheel_fr_2_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[143.154, 71.13, -204.266]} />
        ...
        <AnimatedGroup stage={25} currentStage={currentStage}>
          ...
          <group position={[-2729.823, 0, 691.901]} rotation={[0, 1.571, 0]}>
            ...
            <mesh geometry={nodes.Wheel_fr_6_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[143.128, 96.186, -190.265]} />
          ...
          <group position={[-4319.04, 0, 5880.752]}>
            <group position={[-164.532, 125.564, 190.163]}><mesh geometry={nodes.Wheel_rl_5_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0.001, 0, 0]} /></group>
            <mesh geometry={nodes.Vehicle_Tractor_02_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} />
            <mesh geometry={nodes.Wheel_fl_5_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-143.128, 96.186, -190.264]} />
            <mesh geometry={nodes.Wheel_fr_5_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[143.129, 96.186, -190.264]} />
          ...
          <group position={[-3718.386, 7.539, 4827.763]}>
            ...
            <mesh geometry={nodes.Vehicle_Tractor_Digger_02_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, -0.001]} />
          ...
          <group position={[-516.604, 0, -980.49]}>
            ...
            <mesh geometry={nodes.Wheel_fl_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-143.129, 96.186, -190.264]} />
            <mesh geometry={nodes.Wheel_fr_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[143.128, 96.186, -190.264]} />
            <mesh geometry={nodes.Wheel_rl_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[-164.532, 125.564, 190.164]} />
            <mesh geometry={nodes.Wheel_rr_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[164.532, 125.564, 190.164]} />
          </group>
          <group position={[-1393.537, 4.833, 2739.849]} rotation={[0, -0.496, 0]}>
            <group position={[-143.129, 96.186, -177.327]}><mesh geometry={nodes.Wheel_fl_9_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0.001]} /></group>
          ...
          <group position={[-2917.497, 0, 6319.805]}>
            <group position={[-164.533, 125.564, 203.099]}><mesh geometry={nodes.Wheel_rl_1_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, 0, 0]} /></group>
          ...
          <group position={[1435.408, 0, 4728.562]}>
            <group position={[0, 2484.551, 0]} rotation={[0, 0.704, -0.041]}>
              <mesh geometry={nodes.Windmil_Top_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} />
              <mesh geometry={nodes.Windmill_Blades_SimpleFarm_0.geometry} material={materials['SimpleFarm.001']} position={[0, -3.612, -284.215]} />
            </group>
