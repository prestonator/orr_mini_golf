...
import { AnimatedGroup } from '../Homestead'
...
export function Stages({ nodes, materials, currentStage }: { nodes: any, materials: any, currentStage: number }) {
  return (
    <group scale={0.01}>
        ...
        {/* Stage 2: Main Dirt Driveway & Paths */}
        ...
        {/* Stage 16: Cottage & White Fencing */}
        ...
        {/* Stage 18: House Polish (Windmill & Mailbox) */}
        ...
        {/* Stage 19: Perimeter Fencing - Part 1 */}
        ...
        {/* Stage 20: Perimeter Fencing - Part 2 & Sign */}
        ...
        {/* Stage 23: Year 3 - Vintage Vehicles & Utes */}
        ...
        {/* Stage 24: Year 4 - Plows & Tractors */}
        ...
        {/* Stage 25: Year 5 - Heavy Harvesters & Balers */}
